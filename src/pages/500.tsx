  ...
  return (
    <div className="flex h-screen w-full flex-col items-center justify-center">
      ...
      <div className="flex flex-col items-center justify-center">
        <p className="mt-8 text-5xl font-bold tracking-wider text-gray-300 md:text-6xl lg:text-7xl">
          {code}
        </p>
        <p className="mt-2 text-2xl font-bold text-gray-300 md:text-3xl lg:text-4xl">
          Server Error
        </p>
        <p className="mt-4 text-gray-200 md:text-lg xl:text-xl">{message}</p>
      </div>
    </div>
  );
}
