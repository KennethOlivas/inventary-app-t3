...
const TecInfo = () => {
  return (
    <div className="space-y-10 text-white sm:grid sm:grid-flow-col sm:grid-cols-2 sm:grid-rows-3 sm:gap-x-6 sm:gap-y-14 sm:space-y-0 md:grid-cols-3 md:grid-rows-2 lg:gap-x-8">
      <Card
        icon={
          <svg
            aria-hidden="true"
        ...
        title="Next.js"
        description="Next.js offers a lightly opinionated, heavily optimized approach to
      ...
      <Card
        ...
        description="Prisma is the best way to work with databases in TypeScript. It
          provides a simple, type-safe API to query your database, and it can be
          used with most SQL dialects (and Mongo too!)."
        title="Prisma"
      ...
      <Card
        ...
        title="TypeScript"
        description="  We firmly believe TypeScript will help you be a better web developer.
          Whether you're new to JS or a seasoned pro, the strictness of
          TypeScript leads to smoother building."
      ...
      <Card
        ...
        title="tRPC"
        description="tRPC is a framework-agnostic data fetching library that helps you build fast, type-safe and developer-friendly APIs.  If your frontend and backend are TypeScript, it's really hard to beat
          the DX of tRPC. Kinda like GraphQL but without the work - seriously
          this lib is magic."
        href="https://trpc.io/"
      />
      <motion.div
      ...
      >
        ...
        <div className="text-t3-purple-100 m-6 text-sm subpixel-antialiased md:text-base">
          When you need flexible, secure, and scalable auth, NextAuth.js is top
          notch. It ties into your existing database and provides a simple API
          to manage users and sessions.
        </div>
      </motion.div>
    </div>
  );
